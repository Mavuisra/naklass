<?php
/**
 * Installation Simple Finale du Système de Notifications Naklass
 * Version sans transactions pour éviter les erreurs
 */
...
try {
    ...
    echo "<h2>🚀 Installation Simple Finale du Système de Notifications Naklass</h2>";
    ...
    // 7. Insérer les canaux par défaut
    echo "<h4>Étape 7: Insertion des Canaux</h4>";
    $channels = [
    ...
    foreach ($channels as $channel) {
        try {
            ...
            echo "⚠️ Canal déjà existant: " . $channel[0] . "<br>";
        }
    }
    echo "✅ Canaux insérés<br>";
    
    // 8. Insérer les templates par défaut
    echo "<h4>Étape 8: Insertion des Templates</h4>";
    $templates = [
        // Académiques
    ...
    foreach ($templates as $template) {
        try {
            ...
            echo "⚠️ Template déjà existant: " . $template[0] . "<br>";
        }
    }
